...
winlinkgpx = r'c:\users\maddox\opencpn\winlink.gpx'
y= r'c:\users\maddox\opencpn\winlink-station-list.txt'
    ...
    if state == 1:                          # Search for line with dashes
        ...
        if isblank:
            ...
            if lines[x].startswith(dbldash):
                ...
                gpx_waypoint.time = mod_datetime.datetime(2017, 10, 5, 23, 19, 21)
